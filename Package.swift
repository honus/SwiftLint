...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/honus/SwiftLint/releases/download/test/SwiftLintBinary-macos.artifactbundle.zip",
            checksum: "e6356b0f48c0a3259465e54701fbc3636e36afea110ee647b03ead81ffe8d8fc"
        )
    ]
)
